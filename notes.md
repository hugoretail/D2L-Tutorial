...
Vocabulary: features, dimensionality (length of the vectors), statistical models, 
loss function(s), surrogate objective, training set, test set, overfitting.
